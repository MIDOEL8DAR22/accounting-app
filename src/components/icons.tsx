...
function Base({ size = 20, className, children, ...props }: IconProps) {
  return (
    <svg
...
export const IconNotebook = (p: IconProps) => (
  <Base {...p}>
    ...
    <path d="M2 14h4" />
    <path d="M2 18h4" />
    <rect x="7" y="2" width="15" height="20" rx="2" ry="2" />
    <path d="M16 2v20" />
  </Base>
)
...
export const IconChartDown = (p: IconProps) => (
  <Base {...p}>
...
export const IconListDot = (p: IconProps) => (
  <Base {...p}>
...
const STAGE_ICONS: Record<string, FC<IconProps>> = {
  book: IconBookOpen,
  tag: IconTag,
  search: IconSearch,
  arrows: IconChartUp,
...
export const IconStage = ({ name, ...props }: IconProps & { name: string }) => {
  const Cmp = STAGE_ICONS[name] ?? IconBookOpen
  return <Cmp {...props} />
}
