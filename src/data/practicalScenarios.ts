...
export const SCENARIOS: Scenario[] = [
  ...
  {
    id: 'import-export-co',
    title: 'شركة التجارة الدولية',
    business: 'شركة استيراد وتصدير — شحنات بالدين، جمارك، وخيوط خصم مسموح به وخصم مكتسب زي الشغل الحقيقي.',
    stepsIntro: ['رأس المال والتمويل', 'استيراد شحنة والجمارك', 'المبيعات والخصومات الحقيقية', 'لسداد المورد والنتائج'],
    difficulty: 3,
    accountType: {
      'النقدية': 'asset',
      'البنك': 'asset',
      ...
      'المبيعات': 'revenue',
      'خصم مكتسب': 'revenue',
      'خصم مسموح به': 'expense',
      'مصروف الجمارك': 'expense',
      'مصروف عمومي': 'expense',
      'رأس المال': 'equity',
      'المسحوبات': 'drawing',
    },
    txs: [
      { id: 's7-1', date: 'يوم 1', story: 'رأس مال الشركة: 250,000 نقدًا', debit: { account: 'النقدية', amount: 250000 }, credit: { account: 'رأس المال', amount: 250000 } },
      { id: 's7-2', date: 'يوم 1', story: 'أودع 150,000 من الصندوق في البنك', debit: { account: 'البنك', amount: 150000 }, credit: { account: 'النقدية', amount: 150000 } },
      { id: 's7-3', date: 'يوم 1', story: 'استورد شحنة بضاعة بالدين من المورد 130,000', debit: { account: 'المشتريات', amount: 130000 }, credit: { account: 'الموردون', amount: 130000 } },
      { id: 's7-4', date: 'يوم 2', story: 'دفع رسوم جمارك وتخليص 12,000 نقدًا', debit: { account: 'مصروف الجمارك', amount: 12000 }, credit: { account: 'النقدية', amount: 12000 } },
      { id: 's7-5', date: 'يوم 2', story: 'باع بضاعة نقدًا: 110,000', debit: { account: 'النقدية', amount: 110000 }, credit: { account: 'المبيعات', amount: 110000 } },
      { id: 's7-6', date: 'يوم 2', story: 'باع بضاعة لعميل بالأجل: 80,000', debit: { account: 'العملاء', amount: 80000 }, credit: { account: 'المبيعات', amount: 80000 } },
      { id: 's7-7', date: 'يوم 3', story: 'منح عميل خصمًا مسموحًا به: 5,000', debit: { account: 'خصم مسموح به', amount: 5000 }, credit: { account: 'العملاء', amount: 5000 } },
      { id: 's7-8', date: 'يوم 4', story: 'سدد للمورد 127,000 نقدًا', debit: { account: 'الموردون', amount: 127000 }, credit: { account: 'النقدية', amount: 127000 } },
      { id: 's7-9', date: 'يوم 4', story: 'حصل على خصم مكتسب من المورد: 3,000', debit: { account: 'الموردون', amount: 3000 }, credit: { account: 'خصم مكتسب', amount: 3000 } },
      { id: 's7-10', date: 'يوم 4', story: 'دفع مصاريف عمومية 15,000 نقدًا', debit: { account: 'مصروف عمومي', amount: 15000 }, credit: { account: 'النقدية', amount: 15000 } },
      { id: 's7-11', date: 'يوم 4', story: 'سحب صاحب الشركة 6,000 للاستخدام الشخصي', debit: { account: 'المسحوبات', amount: 6000 }, credit: { account: 'النقدية', amount: 6000 } },
    ],
  },
  {
    id: 'restaurant-cafe',
    title: 'مطعم وكافيه باب الحبايب',
    business: 'مطعم وكافيه — خامات وأكل وشرب، تجهيز معدات، ومبيعات نقدًا وآجل.',
    stepsIntro: ['رأس المال وتجهيز المطبخ', 'الخامات والإيرادات', 'المرتبات والمصروفات', 'التحصيل والمسحوبات'],
    difficulty: 2,
    accountType: {
      'النقدية': 'asset',
      'البنك': 'asset',
    ...
    txs: [
      { id: 's8-1', date: 'يوم 1', story: 'رأس مال المطعم: 90,000 نقدًا', debit: { account: 'النقدية', amount: 90000 }, credit: { account: 'رأس المال', amount: 90000 } },
      { id: 's8-2', date: 'يوم 1', story: 'أودع 30,000 من الصندوق في البنك', debit: { account: 'البنك', amount: 30000 }, credit: { account: 'النقدية', amount: 30000 } },
      { id: 's8-3', date: 'يوم 1', story: 'اشترى ثلاجات ومعدات مطبخ 25,000 بشيك', debit: { account: 'الآلات والمعدات', amount: 25000 }, credit: { account: 'البنك', amount: 25000 } },
      { id: 's8-4', date: 'يوم 2', story: 'اشترى خامات أكل وشرب 15,000 نقدًا', debit: { account: 'المشتريات', amount: 15000 }, credit: { account: 'النقدية', amount: 15000 } },
      { id: 's8-5', date: 'يوم 2', story: 'إيراد مبيعات المطعم نقدًا: 45,000', debit: { account: 'النقدية', amount: 45000 }, credit: { account: 'إيراد مبيعات', amount: 45000 } },
      { id: 's8-6', date: 'يوم 2', story: 'مبيعات لشركة بالأجل: 12,000', debit: { account: 'العملاء', amount: 12000 }, credit: { account: 'إيراد مبيعات', amount: 12000 } },
      { id: 's8-7', date: 'يوم 3', story: 'دفع مرتبات الشيف والعمالة 8,000 نقدًا', debit: { account: 'مصروف المرتبات', amount: 8000 }, credit: { account: 'النقدية', amount: 8000 } },
      { id: 's8-8', date: 'يوم 3', story: 'دفع إيجار المحل 6,000 نقدًا', debit: { account: 'مصروف الإيجار', amount: 6000 }, credit: { account: 'النقدية', amount: 6000 } },
      { id: 's8-9', date: 'يوم 3', story: 'دفع فاتورة كهرباء ومياه 1,500 نقدًا', debit: { account: 'مصروف الكهرباء', amount: 1500 }, credit: { account: 'النقدية', amount: 1500 } },
      { id: 's8-10', date: 'يوم 4', story: 'دفع صيانة معدات المطبخ 2,000 نقدًا', debit: { account: 'مصروف الصيانة', amount: 2000 }, credit: { account: 'النقدية', amount: 2000 } },
      { id: 's8-11', date: 'يوم 4', story: 'سحب صاحب المطعم 3,500 للاستخدام الشخصي', debit: { account: 'المسحوبات', amount: 3500 }, credit: { account: 'النقدية', amount: 3500 } },
    ],
  },
]
